...
//  Art Journal Prompts
//
//  Created by Julie Hess on 3/3/24.
//
...
- (IBAction)Generation:(id)sender {
    ...
    NSArray *facts = @[@"Be creative and make some art inspired by the words Blooming Heart and write about it.", //1
                       @"What comes to mind when you think of your hand? Make some art and write about it.", //2
    ...
    self.Generation.text = facts[randomGeneration];
